...
def data_streams(drone:Drone, model:Model, drone_collection, rover_collection):
    ...
    update_loop.call_soon_threadsafe(listener_mongo_data, drone, model, drone_collection, rover_collection, exit_event)
...
def main_start(serial=None, connection=None, drone_collection=None, rover_collection=None):
    if serial != None:
        ...
        data_streams(drone=drone, drone_collection=drone_collection, rover_collection=rover_collection)
